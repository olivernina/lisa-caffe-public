...
REGISTER_LAYER_CLASS(DIAG_INNER_PRODUCT, DiagInnerProductLayer);
...
REGISTER_LAYER_CLASS(IDX21HOT, Idx2OneHotLayer);
...
REGISTER_LAYER_CLASS(LSTM, LSTMLayer);
REGISTER_LAYER_CLASS(LSTM_UNIT, LSTMUnitLayer);
...
REGISTER_LAYER_CLASS(REDUCTION, ReductionLayer);
REGISTER_LAYER_CLASS(RESET_RNN, ResetRNNLayer);
REGISTER_LAYER_CLASS(SAMPLE, SampleLayer);
