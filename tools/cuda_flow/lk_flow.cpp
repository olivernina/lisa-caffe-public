...
//
// lk_flow.cpp
// Main file for testing OpenCV GPU Lucas Kanade Dense Optical Flow
...
{
    // Variables for CUDA Lucas-Kanade Optical flow
    ...
    if( argc != 2 )
    {
        ...
        cout << "The format is: ./lk_flow video_file.avi" << endl;
        return -1;
    }
    ...
    dflow.winSize = Size(winSize,winSize);
    dflow.iters = iters;
