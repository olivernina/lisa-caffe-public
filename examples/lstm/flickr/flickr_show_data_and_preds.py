...
DATA_FILE = './cocoflickr/coco_flickr30k_hdf5/buffer_100_maxwords_20/train_batches/batch_0.h5'
VOCAB_FILES = ['./cocoflickr/coco_flickr30k_hdf5/buffer_100_maxwords_20/vocabulary.txt']
# MODEL_FILE = './snapshots/coco_flickr_30k_alexnet_to_lstm_4layer_lr0.1_mom_0.9_iter_10000.caffemodel'
# MODEL_FILE = './snapshots/coco_flickr_30k_alexnet_to_lstm_4layer_lr0.1_mom_0.9_noimage_iter_30000.caffemodel'

MODEL_FILE = './snapshots/coco_flickr_30k_alexnet_to_lstm_4layer_lr0.1_mom_0.9_iter_31000.caffemodel'
NET_FILE = './alexnet_to_lstm_net.prototxt'
# MODEL_FILE = './snapshots/flickr_30k_alexnet_to_lstm_4layer_lr0.1_mom0.9_noimagebaseline_iter_10000.caffemodel'
# NET_FILE = './alexnet_to_lstm_net.noimageinput.prototxt'

# DATA_FILE = './cocoflickr/coco_flickr30k_hdf5/buffer_100_maxwords_20/train_batches/batch_0.h5'
# VOCAB_FILES = ['./cocoflickr/coco_flickr30k_hdf5/buffer_100_maxwords_20/vocabulary.txt']
# MODEL_FILE = './snapshots/coco_flickr_30k_alexnet_to_lstm_4layer_lr0.1_mom_0.9_noimage_iter_33000.caffemodel'
# NET_FILE = './alexnet_to_lstm_net.2layer.noimageinput.prototxt'
...
#     'net_data': 0,
    'input_input_sentence': 0,
    'net_input_sentence': 0,
    'input_target_sentence': 0,
    'net_target_sentence': 0,
    'net_target_sentence': 0,
    'net_data_fr': 0,
    'net_data_en': 1,
#     'net_targets': 1,
...
displays = [
  ...
  ('input', 'net_input_sentence_s', 'net_input_sentence', 'input_input_sentence'),
  ('target', 'net_target_sentence_s', 'net_target_sentence', 'input_target_sentence'),
